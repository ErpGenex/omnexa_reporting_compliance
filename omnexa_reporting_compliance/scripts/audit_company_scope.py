#!/usr/bin/env python3
"""Audit company/branch scoping — omnexa_reporting_compliance."""
...
def run():
	...
	return {"ok": True, "app": "omnexa_reporting_compliance", "company": company, "branch": branch, "uses_session_context": bool(company)}
