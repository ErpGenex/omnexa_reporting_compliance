...
from omnexa_reporting_compliance.rc_gap_register import get_gap_status
from omnexa_reporting_compliance.rc_global_benchmark import get_global_rc_score

@frappe.whitelist()
def export_rc_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_REPORTING_COMPLIANCE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_rc_score(), get_gap_status()
